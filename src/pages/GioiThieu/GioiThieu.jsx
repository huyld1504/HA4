      ...
      <main className="gioithieu-main">
        ...
        <section className="gioithieu-hero" aria-labelledby="hero-title">
          <div className="gioithieu-hero__content">
            <span className="gt-hero-badge">Nghệ Thuật Ký Ức 4.0</span>
            <h1 id="hero-title">Kết nối di sản văn hóa với công nghệ hiện đại</h1>
            <p className="gt-hero-description">
              Một sáng kiến sáng tạo kết hợp nghệ thuật truyền thống với trí tuệ nhân tạo, 
              tái hiện di sản văn hóa Việt Nam dưới góc nhìn mới mẻ và sinh động.
            </p>
            <div className="gioithieu-hero__actions">
        ...
        {/* Statistics Section */}
        <section className="gioithieu-stats-section" aria-label="Số liệu nổi bật">
        ...
        <section className="gioithieu-section gt-overview" id="gioi-thieu" aria-labelledby="overview-title">
        ...
        {/* Sứ mệnh */}
        <section className="gioithieu-section gt-mission" id="su-menh" aria-labelledby="gt-mission-title">
          <div className="gt-section-container">
            <div className="gt-section-heading">
        ...
        {/* Tầm nhìn */}
        <section className="gioithieu-section gt-vision" id="tam-nhin" aria-labelledby="vision-title">
          <div className="gt-section-container">
            <div className="gt-section-heading">
