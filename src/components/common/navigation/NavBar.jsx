...
const NavBar = () => {
  ...
  const menuItems = useMemo(() => [
    ...
    submenu: [
      ...
      { label: 'Hồ sơ cá nhân', link: '/profile' },
      { label: 'Bạn bè', link: '/friends' },
      { label: 'Liên hệ', link: '/contact-page' }
    ]
                    ...
                    <div className="bg-[#2a1a0f] rounded-xl shadow-2xl border border-[#4a2d18]/50 overflow-hidden backdrop-blur-sm">
                      <ul className="py-2">
                        {[
                          ...
                          { label: 'Hồ sơ cá nhân', link: '/profile', icon: 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
